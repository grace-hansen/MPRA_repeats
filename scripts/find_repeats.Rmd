...
EMVar_repeats=system("bedtools intersect -a rmsk_hg38.bed -b ~/medusa/projects/MPRA/WHR/results/sig_EMVars.bed -wa -wb",intern=TRUE)
...
EMVar_rsids<-fread("~/medusa/projects/MPRA/WHR/results/sig_EMVars.bed",header=FALSE)
...
enhancer_repeats=system("bedtools intersect -a rmsk_hg38.bed -b ~/medusa/projects/MPRA/WHR/results/sig_enhancers.bed -wa -wb",intern=TRUE)
...
enhancer_rsids<-fread("~/medusa/projects/MPRA/WHR/results/sig_enhancers.bed",header=FALSE)
...
nonsig_repeats=system("bedtools intersect -a rmsk_hg38.bed -b ~/medusa/projects/MPRA/WHR/results/nonsig_rsids.bed -wa -wb",intern=TRUE)
...
nonsig_rsids<-fread("~/medusa/projects/MPRA/WHR/results/nonsig_rsids.bed",header=FALSE)
...
Are there more repeats and Alus than expected by chance?
...
repeat_p<-chisq.test(observed,expected)
...
#pdf("MPRA_vars_in_Alus.pdf",width=5,height=4)
ggplot(summary)+
